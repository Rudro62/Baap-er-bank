// // add event handler to the target button 
// document.getElementById('btn-deposite').addEventListener('click', function () {
//     const depositeField = document.getElementById('deposite-data');
//     const newDepositeAmountString = depositeField.value;
//     const newDepositeAmount = parseFloat(newDepositeAmountString);

//     const depositeTotalAmount = document.getElementById('deposite-total');
//     const previousTotalAmountString = depositeTotalAmount.innerText;
//     const previousTotalAmount = parseFloat(previousTotalAmountString);
//     const currentDepositeTotal = previousTotalAmount + newDepositeAmount;
